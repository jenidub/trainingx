...
import { ChatTranscript } from "@/components/study-buddy/chat-transcript";
import { PreConnectMessage } from "@/components/study-buddy/preconnect-message";
import { TileLayout } from "@/components/study-buddy/tile-layout";
import {
  AgentControlBar,
    ...
    >
      ...
      <div
        className={cn(
          ...
          chatOpen ? "z-40 bg-background" : "pointer-events-none"
        )}
      >
