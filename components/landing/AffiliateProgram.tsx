      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-slate-600 mb-8 leading-relaxed">
            Be part of our Mission. We’re building this to make AI easy and
            accessible for everyone. Soon, you’ll be able to support that
            mission by sharing the product with others and getting rewarded for
            it. Affiliate program coming soon.
          </p>
          {/* 
