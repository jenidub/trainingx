      ...
      <div className="min-h-full bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            >
              <div className="h-24 w-24 rounded-3xl bg-white border-2 border-b-[6px] border-slate-200 flex items-center justify-center text-purple-500 shadow-sm">
            ...
            <CardContent className="p-8 space-y-8">
              ...
              <div className="flex justify-end pt-2">
                <JuicyButton
                  variant="primary"
                  size="lg"
                  className="w-full sm:w-auto text-lg px-10 py-8 rounded-2xl bg-purple-500 border-purple-700 hover:bg-purple-400 active:border-purple-700"
