        ...
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
            <Link href="/assessment-lite" className={"w-full md:w-auto"}>
              <Button
                size="lg"
                className="bg-white text-black border-2 border-white font-semibold py-4 w-full md:w-[300px] hover:bg-white/90"
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-2 border-white text-white bg-slate-600/60 backdrop-blur-sm font-semibold py-4 w-full md:w-[300px]"
