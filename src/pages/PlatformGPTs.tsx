...
export default function PlatformGPTs() {
  return (
      ...
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold tracking-tight" data-testid="text-platform-gpts-title">AI Platform Tools</h1>
                    ...
                    <div className="space-y-4">
                      <div className="flex flex-wrap gap-2">
                        {platform.features.map((feature) => (
                          <Badge key={feature} variant="secondary" data-testid={`badge-${platform.id}-${feature.toLowerCase().replace(/\s+/g, '-')}`}>
                            {feature}
                          </Badge>
                        ))}
                      </div>
